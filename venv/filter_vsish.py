...
VSI_PKT_DROP_PATTERN = r'Time|vNIC packet drop Rate vsish:n294-esxi-ht-04\.sc\.sero\.gic\.ericsson\.se-standard5gc-htnp-b9f7d6d9b-z574b.*'
VSI_PKT_DROP_PATTERN = r'Time|.*vsish.*'+VM_PATTERN+'.*[T|R]x'

'''
Samples: 
vNIC packet drop Rate vsish:n294-esxi-ht-04.sc.sero.gic.ericsson.se-standard5gc-htnp-b9f7d6d9b-z574b.eth2-droppedRx

vNIC packet drop Rate vsish:n294-esxi-ht-04.sc.sero.gic.ericsson.se-standard5gc-htnp-b9f7d6d9b-z574b.eth2-droppedTx
'''
vsi_pkts_dropped_df = df.filter(regex=VSI_PKT_DROP_PATTERN)
print("Lines matching "+VSI_PKT_DROP_PATTERN)
analyze_df_cols(vsi_pkts_dropped_df)
